...
OSF.InitializationHelper.prototype.loadAppSpecificScriptAndCreateOM=function OSF_InitializationHelper$loadAppSpecificScriptAndCreateOM(appContext, appReady, basePath)
{
	...
	OSF.DDA.OutlookAppOm._convertToOutlookParameters$p=function(dispid, data)
	{
		...
		switch(dispid)
		{
			...
			case 36:
				...
				break;
			case 43:
				executeParameters = [data["id"]];
				break;
			case 44:
				executeParameters = [OSF.DDA.OutlookAppOm._convertRecipientArrayParameterForOutlookForDisplayApi$p(data["recipientTo"])];
				break;
			default:
	...
	OSF.DDA.OutlookAppOm.prototype={
		...
		showPersonaCard: function (id) {
			if ($h.ScriptHelpers.isNullOrUndefined(id))
				throw Error.argumentNull("id");
			this._invokeHostMethod$i$0(43, "ShowPersonaCard", {
				id: id
			}, null)
		},
		displayNewMessageForm: function (parameters) {
			var updatedParameters = {};
			updatedParameters["recipientTo"] = parameters["recipientTo"];
			this._invokeHostMethod$i$0(44, "DisplayNewMessageForm", updatedParameters, null)
		},
		GetIsRead: function()
		{
